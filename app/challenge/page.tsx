...
<p className="text-gray-700 mb-6">Bring your sharpest arguments, stress tests, and reviews. Help us improve the ideas and the build.</p>
...
{/* Add other challenge areas here as you grow */}
</div>
</main>
)
}